...
export default function Home(){
    ...
    return (
        ...
        <div style={{
            ...
            <Navigator destination="/example" destinationName="Exemplo" color="purple"></Navigator>
            ...
            <Navigator destination="/staticcontent" destinationName="Conteúdo Estático" color="#db66ed"></Navigator>
